...
const url = `https://686f975191e85fac42a1b05c.mockapi.io/api/users?limit=${limit}`;
...
const updateUserEvent = (userNode) => {
  console.log("updating user");
  userNode.addEventListener('click', (event) => {  event.stopPropagation();
  userForm.querySelector("label[for='heading']").textContent= "Update user"
  userForm.querySelector("input[id='first-name']").value=resData
...
userFormSubmit.addEventListener("click",()=>{
